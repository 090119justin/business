            ...
            <div class="card-body">
              <div class="tab-pane fade show active profile-overview" id="profile-overview">
                  ...
                  <div class="col-lg-10">
                    ...
                    <nav aria-label="Page navigation example">
                      <ul class="pagination justify-content-end">
                        <li class="page-item">
                          <a class="page-link" href="pages-business-details-p4.php?view_data4=<?php echo $rows['bisd'] ?>" aria-label="Previous">
                ...
                <div class="d-grid gap-2 mt-3">
                  <a class="btn btn-success" href="pages-my-businesses.php">Back to My Businesses</a>
                </div>
