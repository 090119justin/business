            ...
            <div class="col-lg-6 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-8">
                ...
                <div class="card-body">
                  ...
                  <form class="row g-3 needs-validation" novalidate method="post" action="php/user-registration.php">
                    <div class="col-12">
                    ...
                    <div class="col-12">
                      <label for="yourNumber" class="form-label">Contact No.</label>
                      <input type="text" name="contactNo" class="form-control" id="yourNumber" required>
