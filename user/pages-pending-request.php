            ...
            <div class="card" >
              <div class="card-body">
                ...
                <?php
                  ...
                  $sql = "SELECT * from requirements where personId = $personId order by id desc";
                ...
                <form class="row g-3 needs-validation" style="padding-top: 20px;">              
                 <?php 
                    if($row['DTIBusNameReg'] === "verified" && $row['BrgyClearance'] === "verified" && $row['ZoningClearance'] === "verified" && $row['CEO'] === "verified" && $row['BFP'] === "verified" && $row['CHO'] === "verified" && $row['ContractOflease'] === "verified" && $row['Cedula'] === "verified" && $row['InvestedCapital'] === "verified" && $row['Picture'] === "verified" && $row['Others'] === "verified"){ ?>
                      <div class="d-grid gap-2 mt-3">
                        <a href="pages-new-business-form.php" class="btn btn-primary" name="requirements">Proceed</a>
                      </div>
                    <?php }else { ?>
                      <div class="d-grid gap-2 mt-3">
                        <button class="btn btn-secondary" disabled="" name="requirements" type="submit">Submit necessary requirements before you proceed</button>
                      </div>
                      <?php }?>
