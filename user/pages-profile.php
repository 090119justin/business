       ...
       <!--  <li class="nav-item dropdown">
        ...
        <li class="nav-item dropdown pe-3">
          ...
          <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
            ...
            <span class="d-none d-md-block dropdown-toggle ps-2"><?php echo ucwords($_SESSION['firstName'])[0].". ". ucwords($_SESSION['lastName']); ?></span>
        ...
        <div class="col-xl-4">
          ...
          <div class="card">
            <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
              ...
              <img src="<?php echo $_SESSION['photo']; ?>" alt="Profile" class="rounded-circle">
              <center><h2><?php echo ucwords($_SESSION['firstName'])." ".ucwords($_SESSION['lastName']); ?></h2></center>
              <h3>User</h3>
              ...
              <div class="tab-content pt-2">
                ...
                <div class="tab-pane fade show active profile-overview" id="profile-overview">
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-9 col-md-8"><?php echo $_SESSION['firstName']." ".strtoupper($_SESSION['middleName'][0]).". ".$_SESSION['lastName']; ?></div>
                  </div>

                  <div class="row">
                    <div class="col-lg-3 col-md-4 label">Birthdate</div>
                    <div class="col-lg-9 col-md-8"><?php echo strftime('%d/%m/%Y',
                    strtotime($_SESSION['birthDate'])); ?></div>
                  </div>
                ...
                <div class="tab-pane fade profile-edit pt-3" id="profile-edit">
                  ...
                  <!-- Profile Edit Form -->
                  <form action="php/user-upload.php" method="post" enctype="multipart/form-data">
                      

                    <div class="row mb-3">
                      <label for="profileImage" class="col-md-4 col-lg-3 col-form-label">Profile Image</label>
                      <div class="col-md-8 col-lg-9">
                        <img src="<?php echo $_SESSION['photo']; ?>" alt="Profile">
                        <div class="pt-2">
                          <label class="btn btn-primary btn-sm" title="Upload new profile image" for="input_upload"><i class="bi bi-upload" style="color:white;"></i></label>                          
                            <input type="file" name="my_image" class="" id = "input_upload" style="display: none;" />
                        </div>
                      </div>
                    </div>
                ...
                <div class="tab-pane fade pt-3" id="profile-change-password">
                  ...
                  <form method="POST" action="php/function-change-password.php">
