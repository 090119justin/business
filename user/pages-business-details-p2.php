                  ...
                  <div class="col-lg-11">
                    ...
                    <nav aria-label="Page navigation example">
                      <ul class="pagination justify-content-end">
                        <li class="page-item">
                          <a class="page-link" href="pages-business-details.php?view_data=<?php echo $row['businessId'] ?>" aria-label="Previous">
                        ...
                        <li class="page-item">
                          <a class="page-link" href="pages-business-details-p3.php?view_data3=<?php echo $row['businessId'] ?>" aria-label="Next">
