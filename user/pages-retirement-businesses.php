<?php $page='services'; $subpage='retireBusiness'; include "includes/user-header.php"; ?>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item">Retirement of businesses</li>
                  ...
                  <tbody>
                    ...
                    while ($row = $result->fetch_assoc()): ?>
                      <tr>
                        ...
                        <td><a class="badge bg-primary text-light" href="pages-retire-business-form.php?business=<?php echo $row['businessId']; ?>"> Retire</a></td>
