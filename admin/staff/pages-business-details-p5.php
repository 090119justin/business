                  ...
                  <div class="col-lg-10">
                    ...
                    <nav aria-label="Page navigation example">
                      <ul class="pagination justify-content-end">
                        ...
                        <li class="page-item"><a class="page-link" href="pages-business-details.php?view_data=<?php echo $rows['bisd'] ?>">1</a></li>
                        <li class="page-item"><a class="page-link" href="pages-business-details-p2.php?view_data2=<?php echo $rows['bisd'] ?>">2</a></li>
                        <li class="page-item"><a class="page-link" href="pages-business-details-p3.php?view_data3=<?php echo $rows['bisd'] ?>">3</a></li>
                        <li class="page-item"><a class="page-link" href="pages-business-details-p4.php?view_data4=<?php echo $rows['bisd'] ?>">4</a></li>
                        <li class="page-item active"><a class="page-link" href="#">5</a></li>
                        <li class="page-item"><a class="page-link" href="pages-business-details-p6.php?view_data6=<?php echo $rows['bisd'] ?>">6</a></li>
                        <li class="page-item">
                          <a class="page-link" href="pages-business-details-p6.php?view_data6=<?php echo $rows['bisd'] ?>" aria-label="Next">
