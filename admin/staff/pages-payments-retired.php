<?php $page='payments'; $subpage='paymentsRetire'; include "../includes/staff-header.php"; ?>
      ...
      <div class="row">
        ...
        <?php       
            $result = $conn->query("select businessId, concat('#',lpad(business.id,4,'0')) as newId ,concat(firstName,' ',lastName) as name, businessName, status
              ...
              where mode = 'retire' and status = 'unpaid';") or die($conn->error);
                    ...
                    while ($row = $result->fetch_assoc()): ?>
                      <tr>
                        ...
                        <td>
                            <a class="icon" href="#" data-bs-toggle="dropdown"><i class="bi bi-three-dots"></i></a>
                            <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                              <li><a href="../php/staff-function-businesses.php?paid-retire=<?php echo $row['businessId']; ?>" class="dropdown-item" name="paid-retire">Paid</a></li>
                              <li><a href="../php/staff-function-businesses.php?unpaid-retire=<?php echo $row['businessId']; ?>" class="dropdown-item" name="unpaid-retire">Unpaid</a></li>                            
                            </ul>
                        </td>
                      </tr>
                  <?php endwhile; ?>
