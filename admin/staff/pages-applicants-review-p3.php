                  ...
                  <div class="col-lg-11">
                    ...
                    <nav aria-label="Page navigation example">
                      <ul class="pagination justify-content-end">
                        ...
                        <li class="page-item"><a class="page-link" href="pages-applicants-review.php?view_data=<?php echo $row['businessId'] ?>">1</a></li>
                        ...
                        <li class="page-item">
                          <a class="page-link" href="pages-applicants-review-p4.php?view_data4=<?php echo $row['businessId'] ?>" aria-label="Next">
