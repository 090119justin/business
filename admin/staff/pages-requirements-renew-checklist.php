<?php $page='requirements'; $subpage='requirementsRenew'; include "../includes/staff-header.php"; ?>
          ...
          <div class="card">
            <div class="card-body">
              ...
              <table class="table table-hover">
                ...
                <button class="btn btn-success" type="submit" name="verifyRenew">SUBMIT</button>
                </div>
