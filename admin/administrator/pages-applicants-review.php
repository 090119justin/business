<?php $page='applicants'; $subpage='applicantsNew'; include "../includes/admin-header.php"; ?>
                  ...
                  <div class="col-lg-11">
                    ...
                    <nav aria-label="Page navigation example">
                      <ul class="pagination justify-content-end">
                        ...
                        <li class="page-item"><a class="page-link" href="pages-applicants-review-p2.php?view_data2=<?php echo $row['businessId'] ?>">2</a></li>
                        <li class="page-item"><a class="page-link" href="pages-applicants-review-p3.php?view_data3=<?php echo $row['businessId'] ?>">3</a></li>
                        <li class="page-item"><a class="page-link" href="pages-applicants-review-p4.php?view_data4=<?php echo $row['businessId'] ?>">4</a></li>
                        <li class="page-item"><a class="page-link" href="pages-applicants-review-p5.php?view_data5=<?php echo $row['businessId'] ?>">5</a></li>
                        <li class="page-item"><a class="page-link" href="pages-applicants-review-p6.php?view_data6=<?php echo $row['businessId'] ?>">6</a></li>
                        <li class="page-item">
                          <a class="page-link" href="pages-applicants-review-p2.php?view_data2=<?php echo $row['businessId'] ?>" aria-label="Next">
