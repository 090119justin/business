<?php $page='payments'; $subpage='paymentsRetire'; include "../includes/admin-header.php"; ?>
                    ...
                    while ($row = $result->fetch_assoc()): ?>
                      <tr>
                        ...
                        <td>
                            <a class="icon" href="#" data-bs-toggle="dropdown"><i class="bi bi-three-dots"></i></a>
                            <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                              <li><a href="php/admin-function-businesses.php?paid=<?php echo $row['businessId']; ?>" class="dropdown-item" name="paid-retire">Paid</a></li>
                              <li><a href="php/admin-function-businesses.php?unpaid=<?php echo $row['businessId']; ?>" class="dropdown-item" name="unpaid-retire">Unpaid</a></li>                            
                            </ul>
                        </td>
                      </tr>
                  <?php endwhile; ?>
