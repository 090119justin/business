                  ...
                  <div class="col-lg-11">
                    ...
                    <nav aria-label="Page navigation example">
                      <ul class="pagination justify-content-end">
                        <li class="page-item">
                          <a class="page-link" href="pages-business-details-renew-p3.php?view_data3=<?php echo $row['bid'] ?>" aria-label="Previous">
                            <span aria-hidden="true">&laquo;</span>
                          </a>
                        </li>
                        <li class="page-item"><a class="page-link" href="pages-business-details-renew.php?view_data=<?php echo $row['bid'] ?>">1</a></li>
                        <li class="page-item"><a class="page-link" href="pages-business-details-renew-p2.php?view_data2=<?php echo $row['bid'] ?>">2</a></li>
                        <li class="page-item"><a class="page-link" href="pages-business-details-renew-p3.php?view_data3=<?php echo $row['bid'] ?>">3</a></li>
                        <li class="page-item active"><a class="page-link" href="#">4</a></li>
                        <li class="page-item"><a class="page-link" href="pages-business-details-renew-p5.php?view_data5=<?php echo $row['bid'] ?>">5</a></li>
                        <li class="page-item"><a class="page-link" href="pages-business-details-renew-p6.php?view_data6=<?php echo $row['businessId'] ?>">6</a></li>
                        <li class="page-item">
                          <a class="page-link" href="pages-business-details-renew-p5.php?view_data5=<?php echo $row['bid'] ?>" aria-label="Next">
