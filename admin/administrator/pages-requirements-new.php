<?php $page='requirements'; $subpage='requirementsNew'; include "../includes/admin-header.php"; ?>
      ...
      <div class="row">
        ...
        <?php       
            ...
            $result = $conn->query("SELECT requirements.id as reqId, personId, concat(firstName,' ',lastName) as name,concat('#',lpad(personId,4,'0')) as newId 
              ...
              where status = 'new' and type = 'new';") or die($conn->error);
          ?> 
        <!-- Recent Applicants -->
        <div class="col-12">
                ...
                <tbody>
                  ...
                  while ($row = $result->fetch_assoc()): 
                    ...
                    <tr>
                      ...
                      <td>
                        <a class="badge bg-info text-dark" href="pages-requirements-new-checklist.php?person_id=<?php echo $personId; ?>&req=<?php echo $reqId; ?>"><i class="bi bi-eye-fill" ></i> View </a>
                      </td>
                    </tr>
                <?php endwhile; ?>
